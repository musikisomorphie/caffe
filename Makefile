...
ifeq ($(BLAS), mkl)
	...
	#echo MKL_DIR
	MKL_DIR := /scratch_net/avatar/jwu/.usr/local/intel/mkl
...
$(TEST_ALL_BIN): $(TEST_MAIN_SRC) $(TEST_OBJS) $(GTEST_OBJ) \
	...
	$(Q)$(CXX) $(TEST_MAIN_SRC) $(TEST_OBJS) $(GTEST_OBJ) \
		-o $@ $(LINKFLAGS) $(LDFLAGS) -l$(PROJECT) -lopencv_imgcodecs -I/scratch_net/avatar/jwu/.usr/local/include -Wl,-rpath,$(ORIGIN)/../lib
